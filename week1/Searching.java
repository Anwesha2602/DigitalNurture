...
public class Searching {
    ...
    public static void main(String[] args) {
        ...
        inventory.addProduct(new Product("P1", "Product A", 10, 20.5));
        inventory.addProduct(new Product("P2", "Product B", 15, 30.0));
        inventory.addProduct(new Product("P3", "Product C", 5, 12.0));
